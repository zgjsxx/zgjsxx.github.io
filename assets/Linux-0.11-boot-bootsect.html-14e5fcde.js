...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="q-a" tabindex="-1"><a class="header-anchor" href="#q-a" aria-hidden="true">#</a> Q &amp; A</h2>`,43),l=[i];function o(p,d){return n(),a("div",null,l)}const r=s(t,[["render",o],["__file","Linux-0.11-boot-bootsect.html.vue"]]);export{r as default};

import{_ as l,V as d,W as r,X as e,Y as n,$ as a,a0 as i,F as c}from"./framework-9a29aaa0.js";const t={},o=i('<hr><p>category:</p><ul><li>汇编语言</li></ul><hr><h1 id="第四讲-算术运算和简单函数" tabindex="-1"><a class="header-anchor" href="#第四讲-算术运算和简单函数" aria-hidden="true">#</a> 第四讲：算术运算和简单函数</h1><h2 id="回顾" tabindex="-1"><a class="header-anchor" href="#回顾" aria-hidden="true">#</a> 回顾</h2><h3 id="寄存器" tabindex="-1"><a class="header-anchor" href="#寄存器" aria-hidden="true">#</a> 寄存器</h3><p>上一讲中，我们学习了我们可用的所有的通用寄存器：<code>rax</code>，<code>rbx</code>，<code>rcx</code>，<code>rdx</code>，<code>rdi</code>，<code>rsi</code>，<code>rbp</code>，<code>rsp</code>，<code>r8</code>至<code>r15</code>。</p><p>我们看到了如何以完整的 64 位 (qword) 宽度或低位双字、低位字或低位字节来访问其中的每一个：</p><figure><img src="https://raw.githubusercontent.com/zgjsxx/static-img-repo/main/blog/language/assembly/fullerton_CSci241/lecture3/common_register.png" alt="common_register" tabindex="0" loading="lazy"><figcaption>common_register</figcaption></figure><p>我们看到许多指令（包括 <code>mov</code> 和 <code>xor</code>）在对寄存器的低位双字部分进行操作时，会隐式地将高位双字清零，并且我们研究了一些保留高位双字的策略。</p><p>我们查看了标志寄存器 <code>rflags</code>，它用于存储有关各种操作结果的信息。对我们来说最重要的标志是:</p><ul><li>CF – 进位标志，如果无符号运算的结果产生额外的进位/借位则设置</li><li>OF – 溢出标志，如果有符号运算的结果太大/太小而无法存储，则设置</li><li>ZF – 零标志，如果结果的所有位均为 0，则设置该标志。</li><li>SF – 符号标志，如果结果的高位被置位则置位</li></ul><p>我们看到 <code>mov</code> 指令是我们在寄存器、内存和立即（常量）值之间移动数据的基本工具。我们还看到了 <code>xchg</code> 指令，它交换操作数，使我们不必使用寄存器作为临时变量。</p><h2 id="负数" tabindex="-1"><a class="header-anchor" href="#负数" aria-hidden="true">#</a> 负数</h2><p>前面描述的所有算术运算符都假设输入值为正。那么如果输入有负数该如何处理？一般来说， 有四种处理办法：</p>',16),u=e("ul",null,[e("li",null,[e("p",null,[n("符号位(源码)： 在十进制中，我们用"),e("code",null,"-"),n("符号表示负数， 那么为什么不用一个位来表示这个数字是负数呢？其实，数字的最高位就是用来做这个事情。例如 00000011b 是 3，但 10000011b 是 -3。虽然这个办法对我们来说很容易理解，但是在实现时确有几个缺点：")]),e("ul",null,[e("li",null,"现在0有两种表示，一个是正数0，一个是负数0。"),e("li",null,"值的算术更加复杂，因为我们必须检查两个值的符号位。如果我们忘记并执行无符号运算，结果将是无意义的。"),e("li",null,"CPU 必须根据符号位的值在执行加法运算和执行减法运算之间切换。也就是说，CPU 无法将自己设置为执行加法/减法，直到它也知道正在操作的值。 浮点值使用符号位，部分原因是它们希望同时具有正零和负零。")])]),e("li",null,[e("p",null,'偏置表示法(biasd)。这表示所有值（不仅仅是负值）都叠加一个固定量。所以0不是0，而是0+127（=01111111b）什么的。 3是3+127=10000010b，-3是-3+127=01111100b。请注意，高位用作一种"正号位"；如果已设置，则该数字为正数（大于 0）。'),e("ul",null,[e("li",null,[e("p",null,"加法和减法（在某种程度上）正常工作，只是我们必须在执行正常运算后​​“消除”值的偏差。例如，添加 3 和 -3 得出："),e("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[e("pre",{class:"language-bash"},[e("code",null,[n("    "),e("span",{class:"token number"},"10000010"),n(`
+  01111100
─────────────
    `),e("span",{class:"token number"},"11111110"),n(),e("span",{class:"token operator"},"="),n(),e("span",{class:"token number"},"127"),n(),e("span",{class:"token punctuation"},"("),e("span",{class:"token number"},"254"),n("-127"),e("span",{class:"token punctuation"},")"),n(` 
`)])]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"})])]),e("p",null,"我们必须再次从结果中减去127，因为添加了两个127的“副本”，所以最终的结果实际上是"),e("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[e("pre",{class:"language-bash"},[e("code",null,[n(),e("span",{class:"token number"},"11111110"),n(`
`)])]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"})])])]),e("li",null,[e("p",null,"01111111 ───────────── 01111111 = 0 (127-127)")])]),e("div",{class:"language-text line-numbers-mode","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`- 正数看起来很奇怪。零看起来很奇怪。
- 检测非负数 (≥ 0) 很棘手。

`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"})])])]),e("li",null,[e("p",null,"反码(Ones-complement)：这将负值表示为相应数字的二进制逆（翻转所有位）。所以 3 是 00000011b，而 -3 是 11111100b。请注意，我们可以通过检查高位来确定数字是否为负数。如果已设置，则该数字为负数。但高位不是符号位。我们不能通过简单地翻转高位来使负数变为正数，我们必须翻转所有位。 如果我们执行+3和-3的二进制加法，我们会得到:"),e("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[e("pre",{class:"language-bash"},[e("code",null,[n(`    00000011
+   `),e("span",{class:"token number"},"11111100"),n(`
─────────────
    `),e("span",{class:"token number"},"11111111"),n(),e("span",{class:"token operator"},"="),n(),e("span",{class:"token parameter variable"},"-0"),n(`
`)])]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"})])]),e("p",null,"与符号位表示一样，0 有两种表示形式，正数（如 00000000b）和负数（如 11111111b）。然而，我们可以使用普通的二进制加法来添加有符号数，并且当解释为补码数时，结果将是正确的。 减法有点困难："),e("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[e("pre",{class:"language-bash"},[e("code",null,[n("   "),e("span",{class:"token number"},"111111"),n(`  
    00000011   `),e("span",{class:"token operator"},"="),n(),e("span",{class:"token number"},"3"),n(`
 -  00000100   `),e("span",{class:"token operator"},"="),n(),e("span",{class:"token number"},"4"),n(`
─────────────
    `),e("span",{class:"token number"},"11111110"),n(),e("span",{class:"token operator"},"="),n("  "),e("span",{class:"token parameter variable"},"-1"),n(` 
`)])]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"})])]),e("p",null,"当借用的 1 到达最左边时，它会“环绕”并从答案的低位借用。这称为末端借用。当这种情况发生时，我们必须做出调整。")]),e("li",null,[e("p",null,[n("补码(Twos-complement)：将负数的值按位取反再加1。8位数字的的补码可以被定义为"),e("span",{class:"katex"},[e("span",{class:"katex-mathml"},[e("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[e("semantics",null,[e("mrow",null,[e("msup",null,[e("mn",null,"2"),e("mn",null,"8")]),e("mo",null,"−"),e("mi",null,"n")]),e("annotation",{encoding:"application/x-tex"},"{2}^{8}-n")])])]),e("span",{class:"katex-html","aria-hidden":"true"},[e("span",{class:"base"},[e("span",{class:"strut",style:{height:"0.8974em","vertical-align":"-0.0833em"}}),e("span",{class:"mord"},[e("span",{class:"mord"},[e("span",{class:"mord"},"2")]),e("span",{class:"msupsub"},[e("span",{class:"vlist-t"},[e("span",{class:"vlist-r"},[e("span",{class:"vlist",style:{height:"0.8141em"}},[e("span",{style:{top:"-3.063em","margin-right":"0.05em"}},[e("span",{class:"pstrut",style:{height:"2.7em"}}),e("span",{class:"sizing reset-size6 size3 mtight"},[e("span",{class:"mord mtight"},[e("span",{class:"mord mtight"},"8")])])])])])])])]),e("span",{class:"mspace",style:{"margin-right":"0.2222em"}}),e("span",{class:"mbin"},"−"),e("span",{class:"mspace",style:{"margin-right":"0.2222em"}})]),e("span",{class:"base"},[e("span",{class:"strut",style:{height:"0.4306em"}}),e("span",{class:"mord mathnormal"},"n")])])]),n("。 所以 3 是 00000011b 而 -3 是 11111101b。请注意，高位仍可用于检测负值。你可以认为补码是反码加上1。")]),e("ul",null,[e("li",null,[e("p",null,'所有的算术运算符都正常工作，无需传入值的符号。我们可以进行正常的加法，无论其中一个或两个输入是否为负，结果都会"有意义"。例如:'),e("div",{class:"language-text line-numbers-mode","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`   1111111
   00000011
+  11111101
─────────────
   00000000 
`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"})])])]),e("li",null,[e("p",null,"所有算术运算都正常工作，无需知道传入值的符号。我们可以进行正常的加法，无论其中一个或两个输入是否为负，结果都会“有意义”。例如。"),e("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[e("pre",{class:"language-bash"},[e("code",null,[n("    "),e("span",{class:"token number"},"1111111"),n(`
    00000011
+  `),e("span",{class:"token number"},"11111101"),n(`
─────────────
    00000000 
`)])]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"})])])]),e("li",null,[e("p",null,"0 只有一种表示形式，而不是两种，而且就是 0b。")]),e("li",null,[e("p",null,"表示的值的范围（通过字节）为 -128 到 +127。")]),e("li",null,[e("p",null,"这里不需要在二进制补码中进行结束借用/进位。"),e("p",null,"x86-x64系统(以及许多其他系统)使用二进制补码，因为它不需要任何额外的电路来表示或操作负数。你只需进行“正常”的二进制加法，结果就是正确的。")])])])],-1),m={href:"https://zh.wikipedia.org/wiki/%E5%8E%9F%E7%A0%81",target:"_blank",rel:"noopener noreferrer"},v={href:"https://zh.wikipedia.org/wiki/%E4%B8%80%E8%A3%9C%E6%95%B8",target:"_blank",rel:"noopener noreferrer"},p={href:"https://zh.wikipedia.org/wiki/%E4%BA%8C%E8%A3%9C%E6%95%B8",target:"_blank",rel:"noopener noreferrer"},b=i(`<p>乘法是一种非常昂贵的运算，我们通常不会费心尝试在数字表示“内部”进行它。相反，我们只是将两个操作数都设为正数，然后相乘，然后根据需要对结果取负。</p><p>另一个例子：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>   <span class="token number">11</span>  <span class="token number">1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这里并不严格要求带上字节限定符，但带上它是一个很好的做法。</p><p>下面是一个容易犯错误的例子:</p><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>mov rax, [my_text] ; Read one *qword* from my_text
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>它读取的不是一个字节而是八个字节（qword）。</p><p>在上面的例子中当你增加字节限定符时进行汇编将会报错。因为限定符和寄存器的大小不匹配。</p><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>mov rax, byte [my_text] ; Read one byte from my_text
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>(<code>mov</code>要求源操作数和目的操作数大小相等，<code>movzx</code>可以实现高位补0操作)</p><p>实际上，如果我们正在处理一个字符串，我们会想要迭代它，而不仅仅是访问第一个字节。将地址 <code>my_text</code> 放入寄存器然后&quot;解引用&quot;会更有用：</p><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>mov rsi, my_text
mov al, byte [rsi]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>然后我们可以通过 <code>inc rsi</code> 来增加 <code>rsi</code>的值从而访问字符串中的下一个字节。因为 <code>my_text</code> 是立即数，所以我们不能递增它。 （同样，<code>[rsi]</code> 上的字节限定符不是必需的，因为它可以从 <code>al</code> 的大小推断出来。）</p><h2 id="简单的循环" tabindex="-1"><a class="header-anchor" href="#简单的循环" aria-hidden="true">#</a> 简单的循环</h2><p>因为做任何有趣的事情都需要循环，所以我们将介绍<code>loop</code>指令。循环采用单个操作数，一个要跳转到的标签（在内部，循环存储标签地址相对于当前指令地址的偏移量）。循环的操作是执行以下步骤：</p><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>    mov rcx, init       ; Initialize rcx &gt; 0
...
call r11
    ...
    mov rsi, rdi
    mov rdi, 1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="附录-1" tabindex="-1"><a class="header-anchor" href="#附录-1" aria-hidden="true">#</a> 附录</h2>`,67),h={href:"https://staffwww.fullcoll.edu/aclifton/cs241/lecture-arithmetic-functions.html",target:"_blank",rel:"noopener noreferrer"};function g(x,k){const s=c("ExternalLinkIcon");return d(),r("div",null,[o,u,e("p",null,[n("(这里原文中的介绍相对比较笼统，细节可以参考维基百科，"),e("a",m,[n("原码"),a(s)]),n("， "),e("a",v,[n("反码"),a(s)]),n("，"),e("a",p,[n("补码"),a(s)]),n("。")]),b,e("p",null,[n("原文链接： "),e("a",h,[n("https://staffwww.fullcoll.edu/aclifton/cs241/lecture-arithmetic-functions.html"),a(s)])])])}const f=l(t,[["render",g],["__file","Lecture4-twos-complement-arithmetic-instructions.html.vue"]]);export{f as default};

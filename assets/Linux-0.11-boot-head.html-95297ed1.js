import{_ as e,V as i,W as n,a0 as s}from"./framework-c954d91f.js";const a={},d=s(`<h1 id="linux-0-11-boot目录head-s详解" tabindex="-1"><a class="header-anchor" href="#linux-0-11-boot目录head-s详解" aria-hidden="true">#</a> Linux-0.11 boot目录head.s详解</h1><h2 id="模块简介" tabindex="-1"><a class="header-anchor" href="#模块简介" aria-hidden="true">#</a> 模块简介</h2><p>在head.s中，操作系统主要做了如下几件事：</p><ul><li>设置中断描述符和全局描述符</li><li>检查A20地址线是否开启</li><li>检查数学协处理器</li><li>初始化页表并开启分页</li><li>跳转到main函数执行</li></ul><h2 id="过程详解" tabindex="-1"><a class="header-anchor" href="#过程详解" aria-hidden="true">#</a> 过程详解</h2><h3 id="设置中断描述符和全局描述符" tabindex="-1"><a class="header-anchor" href="#设置中断描述符和全局描述符" aria-hidden="true">#</a> 设置中断描述符和全局描述符</h3><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>startup_32:
	movl $0x10,%eax
	mov %ax,%ds
	mov %ax,%es
	mov %ax,%fs

import{_ as e,V as d,W as a,a0 as i}from"./framework-c954d91f.js";const s={},n=i(`<h1 id="linux-0-11-kernel目录进程管理asm-s详解" tabindex="-1"><a class="header-anchor" href="#linux-0-11-kernel目录进程管理asm-s详解" aria-hidden="true">#</a> Linux-0.11 kernel目录进程管理asm.s详解</h1><h2 id="模块简介" tabindex="-1"><a class="header-anchor" href="#模块简介" aria-hidden="true">#</a> 模块简介</h2><p>该模块和CPU异常处理相关，在代码结构上asm.s和traps.c强相关。 CPU探测到异常时，主要分为两种处理方式，一种是有错误码，另一种是没有错误码，对应的方法就是<strong>error_code</strong>和<strong>no_error_code</strong>。在下面的函数详解中，将主要以两个函数展开。</p><h2 id="函数详解" tabindex="-1"><a class="header-anchor" href="#函数详解" aria-hidden="true">#</a> 函数详解</h2><h3 id="no-error-code" tabindex="-1"><a class="header-anchor" href="#no-error-code" aria-hidden="true">#</a> no_error_code</h3><p>对于一些异常而言，CPU在出现这些异常时不会将error code压入栈中。其和一般的中断类似，会将ss,esp,eflags,cs,eip这几个寄存器的值压入内核栈中。如下图所示：</p><figure><img src="https://github.com/zgjsxx/static-img-repo/raw/main/blog/Linux/Linux-0.11-kernel/trap/no_error.png" alt="无错误码的情景" tabindex="0" loading="lazy"><figcaption>无错误码的情景</figcaption></figure><p>接下来，以divide_error为例，其会将do_divide_error的地址压入内核栈中， no_error_code第一步便是将do_divide_error的值存入eax中。</p><div class="language-asm line-numbers-mode" data-ext="asm"><pre class="language-asm"><code>no_error_code:
	xchgl %eax,(%esp)
...
iret
	...
	jmp error_code
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="q-a" tabindex="-1"><a class="header-anchor" href="#q-a" aria-hidden="true">#</a> Q &amp; A</h2>`,79),r=[n];function l(o,c){return d(),a("div",null,r)}const u=e(s,[["render",l],["__file","Linux-0.11-kernel-asm.html.vue"]]);export{u as default};

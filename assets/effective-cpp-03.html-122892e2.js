import{_ as n,V as s,W as a,a0 as t}from"./framework-9a29aaa0.js";const e={},o=t(`<h1 id="effective-c-03-尽可能使用const" tabindex="-1"><a class="header-anchor" href="#effective-c-03-尽可能使用const" aria-hidden="true">#</a> effective c++ 03 尽可能使用const</h1><p>在本节中，作者建议我们要尽可能使用const， 这样可以尽可能在编译期暴露一些问题。</p><h2 id="分析" tabindex="-1"><a class="header-anchor" href="#分析" aria-hidden="true">#</a> 分析</h2><h3 id="在可以使用const的地方尽量使用const-可以避免很多错误" tabindex="-1"><a class="header-anchor" href="#在可以使用const的地方尽量使用const-可以避免很多错误" aria-hidden="true">#</a> 在可以使用const的地方尽量使用const，可以避免很多错误</h3><p>const可被用在下面的场景：</p><ul><li>任何作用域的对象</li><li>函数参数</li><li>函数返回值类型</li><li>成员函数本体</li></ul><h3 id="如果在const函数内部需要修改成员变量-则需要使用mutable" tabindex="-1"><a class="header-anchor" href="#如果在const函数内部需要修改成员变量-则需要使用mutable" aria-hidden="true">#</a> 如果在const函数内部需要修改成员变量， 则需要使用mutable</h3><p>编译器通常是bitwise constness，即const成员函数内不能修改任何一个bit。然而现实中，有时候我们需要logical constness,即一个const成员函数可以修改它所处理的对象内的某些bits。 这个时候就需要使用mutable。</p><p>下面是一个例子，如果不使用mutable， 则不能通过编译。</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;string&gt;</span></span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>更常见的一个场景，在一个类中有一个互斥锁的成员变量，在const函数中要对这个互斥锁加锁，那这个时候不加mutable是会失败的。</p><h3 id="当const和non-const成员函数有着实质等价的实现时-令non-const版本调用const版本可避免代码重复" tabindex="-1"><a class="header-anchor" href="#当const和non-const成员函数有着实质等价的实现时-令non-const版本调用const版本可避免代码重复" aria-hidden="true">#</a> 当const和non-const成员函数有着实质等价的实现时，令non-const版本调用const版本可避免代码重复</h3><p>这个点可以参考书本中的实现，但是我觉得这个点使用的频率不是很高。</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;iostream&gt;</span></span>

import{_ as n,V as a,W as s,a0 as e}from"./framework-c954d91f.js";const p={},t=e(`<h1 id="effective-c-06-不自动生成的函数-就明确拒绝" tabindex="-1"><a class="header-anchor" href="#effective-c-06-不自动生成的函数-就明确拒绝" aria-hidden="true">#</a> effective c++ 06 不自动生成的函数，就明确拒绝</h1><h2 id="分析" tabindex="-1"><a class="header-anchor" href="#分析" aria-hidden="true">#</a> 分析</h2><h2 id="方法1-将成员函数声明为private并不予实现" tabindex="-1"><a class="header-anchor" href="#方法1-将成员函数声明为private并不予实现" aria-hidden="true">#</a> 方法1:将成员函数声明为private并不予实现</h2><p>下面是一个例子，这个例子如果进行赋值编译将不会通过。</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token keyword">class</span> <span class="token class-name">HomeForSale</span>

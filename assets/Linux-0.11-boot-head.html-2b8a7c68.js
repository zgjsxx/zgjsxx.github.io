...
check_x87:
	...
	movl %eax,%cr0
	ret
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="step3-初始化页表并开启分页" tabindex="-1"><a class="header-anchor" href="#step3-初始化页表并开启分页" aria-hidden="true">#</a> step3：初始化页表并开启分页</h3><p>下面这里将进行页表的安装，安装的过程参考下面这张图：</p><figure><img src="https://github.com/zgjsxx/static-img-repo/raw/main/blog/Linux/kernel/Linux-0.11/Linux-0.11-boot/head/head_setup_paging.png" alt="页表的设置" tabindex="0" loading="lazy"><figcaption>页表的设置</figcaption></figure><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>after_page_tables:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>建立页表的第一步是对页目录表和页表项进行清零的初始化。</p><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>setup_paging:
	movl $1024*5,%ecx		/* 5 pages - pg_dir+4 page tables */
	xorl %eax,%eax
	xorl %edi,%edi			/* pg_dir is at 0x000 */
	cld;rep;stosl
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由于后面会使用<code>rep</code>前缀，因此首先需要设置循环的次数。页目录表和页表的总大小是<code>1024*4*(4+1)</code>，由于我们使用的是<code>stosl</code>，即一次进行4个字节的初始化操作，于是<code>ecx</code>设置为<code>1024*5</code>。</p><p><code>xorl %eax,%eax</code>和 <code>xorl %edi,%edi</code>将<code>eax</code>和<code>edi</code>设置为0。</p><p>最后使用<code>cld;rep;stosl</code>进行循环赋值。将<code>eax</code>的值依次赋值给<code>0x0， 0x4， 0x8 ...</code>。</p><p>总结起来，这里的作用就是将页目录表和页表全部清零。</p><h3 id="step4-跳转到main函数执行" tabindex="-1"><a class="header-anchor" href="#step4-跳转到main函数执行" aria-hidden="true">#</a> step4：跳转到main函数执行</h3><p>在setup_paging执行完毕之后，会通过ret返回，ret指令会将栈顶的内容弹出到PC指针中去执行。此时esp指向的位置存放的是main函数的地址。因此接下来会执行main函数。</p><p>注意到在将main入栈时，还一同入栈了一些其他参数</p><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>	pushl $0		# These are the parameters to main :-)
	pushl $0
	pushl $0
	pushl $L6

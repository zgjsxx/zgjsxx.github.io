...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>（当然，如果您需要的不仅仅是第一个字节，您可能希望将它们分成八个块，以提高速度......）</p><p>实际上，如果我们正在处理一个字符串，我们会想要迭代它，而不仅仅是访问第一个字节。将地址 <code>my_text</code> 放入寄存器然后&quot;解引用&quot;会更有用：</p><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>mov rsi, my_text
mov al, byte [rsi]

import{_ as s,V as i,W as a,X as n,Y as d,$ as l,a0 as r,F as c}from"./framework-9a29aaa0.js";const v={},u=r(`<h1 id="第七讲-函数和栈" tabindex="-1"><a class="header-anchor" href="#第七讲-函数和栈" aria-hidden="true">#</a> 第七讲 函数和栈</h1><h2 id="条件和循环的示例" tabindex="-1"><a class="header-anchor" href="#条件和循环的示例" aria-hidden="true">#</a> 条件和循环的示例</h2><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>section .data
...
.not_found:
    ...
    mov rax, -1
    ret
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,61),o={href:"https://staffwww.fullcoll.edu/aclifton/cs241/lecture-stack-c-functions.html",target:"_blank",rel:"noopener noreferrer"};function t(m,p){const e=c("ExternalLinkIcon");return i(),a("div",null,[u,n("p",null,[n("a",o,[d("https://staffwww.fullcoll.edu/aclifton/cs241/lecture-stack-c-functions.html"),l(e)])])])}const x=s(v,[["render",t],["__file","Lecture7-functions-and-the-stack.html.vue"]]);export{x as default};

import{_ as t,V as o,W as c,X as n,Y as e,$ as p,a0 as s,F as l}from"./framework-c954d91f.js";const i={},u=s(`<h1 id="effective-c-43-处理模板化基类的名称" tabindex="-1"><a class="header-anchor" href="#effective-c-43-处理模板化基类的名称" aria-hidden="true">#</a> effective c++ 43-处理模板化基类的名称</h1><p>该节主要分析了一个写模板时常常会遇到的一个编译错误。</p><h2 id="分析" tabindex="-1"><a class="header-anchor" href="#分析" aria-hidden="true">#</a> 分析</h2><p>这里有一个模板基类，有派生类继承了模板基类，并调用了基类中的方法，但是编译器却会报找不该方法，这是怎么回事？</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;string&gt;</span></span>

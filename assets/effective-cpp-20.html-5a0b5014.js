...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面主要讲解了传引用的好处， 那么什么时候我们引用考虑传值呢？</p><p>作者这里也给出了解答， 下面三种场景可以考虑直接传值：</p><ul><li>内置类型（只读不修改时）</li><li>STL迭代器</li><li>函数对象</li></ul><p>关于STL迭代器和函数对象为什么可以考虑传值，我在知乎上搜到了下面的解释，我觉得比较有道理：</p><blockquote><p>很多时候迭代器可以做成可平凡复制的小对象（有时就是裸指针或裸指针直接外包），这时值传递迭代器和传递一个指针开销相同。不过例外也是存在的。</p></blockquote><blockquote><p>函数对象的话，无状态函数对象和函数指针是常见的情况。不过“大块头”的函数对象（如 std::function 或状态庞大的函数对象）也不能说少见。这时选择传值还是 const 引用可能就需要斟酌。</p></blockquote><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><ul><li>尽量以传常引用去替代传值。前者通常比较高效，并且可以避免切割问题。</li><li>以上规则并不适用于内置类型 ，以及STL的迭代器和函数对象，对它们而言，传值往往比较合适。</li></ul>`,20),o=[e];function c(l,i){return s(),a("div",null,o)}const d=n(p,[["render",c],["__file","effective-cpp-20.html.vue"]]);export{d as default};

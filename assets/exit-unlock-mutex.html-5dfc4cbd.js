import{_ as n,V as s,W as a,a0 as t}from"./framework-c954d91f.js";const p={},e=t(`<h1 id="如果持有互斥锁的线程没有解锁退出了-该如何处理" tabindex="-1"><a class="header-anchor" href="#如果持有互斥锁的线程没有解锁退出了-该如何处理" aria-hidden="true">#</a> 如果持有互斥锁的线程没有解锁退出了，该如何处理？</h1><h2 id="问题引入" tabindex="-1"><a class="header-anchor" href="#问题引入" aria-hidden="true">#</a> 问题引入</h2><p>看下面一段代码，两个线程将竞争互斥锁mutex而进入临界区， 线程2在竞争互斥锁之前会sleep 2秒， 因此大概率线程一将获得互斥锁。 然而线程1执行完临界区的代码之后， 没有执行解锁操作，就退出了。</p><p>这样会导致线程2将死锁，因为该锁的状态将永远是锁定状态， 它将永远都不能获得锁。</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span><span class="token string">&lt;unistd.h&gt;</span></span>

import{_ as p,V as t,W as e,X as n,Y as s,$ as o,a0 as c,F as l}from"./framework-9a29aaa0.js";const i={},u=c(`<h1 id="effective-c-12-复制对象时勿忘其每一个成分" tabindex="-1"><a class="header-anchor" href="#effective-c-12-复制对象时勿忘其每一个成分" aria-hidden="true">#</a> effective c++ 12 复制对象时勿忘其每一个成分</h1><p>本文也是主要讲解的是赋值构造函数需要复制应该复制的每一个成分，这里面最容易忘记复制的就是基类的成分。</p><h2 id="分析" tabindex="-1"><a class="header-anchor" href="#分析" aria-hidden="true">#</a> 分析</h2><p>本例主要强调在自定义复制构造函数和赋值运算符时一定要检查是否复制了所需要的元素。尤其是派生类中不能忘记复制基类的成分。</p><p>下面便是一个例子，其中的派生类中处理了复制基类的成分。</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;string&gt;</span></span>

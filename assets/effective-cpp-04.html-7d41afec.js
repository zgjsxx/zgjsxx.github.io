import{_ as n,V as s,W as a,a0 as e}from"./framework-9a29aaa0.js";const t={},i=e(`<h1 id="effective-c-04-确定对象被使用前已被初始化" tabindex="-1"><a class="header-anchor" href="#effective-c-04-确定对象被使用前已被初始化" aria-hidden="true">#</a> effective c++ 04 确定对象被使用前已被初始化</h1><h2 id="使用成员变量初始化列表进行初始化" tabindex="-1"><a class="header-anchor" href="#使用成员变量初始化列表进行初始化" aria-hidden="true">#</a> 使用成员变量初始化列表进行初始化</h2><p>下面是赋值:</p><div class="language-CPP line-numbers-mode" data-ext="CPP"><pre class="language-CPP"><code>//01. Assignments

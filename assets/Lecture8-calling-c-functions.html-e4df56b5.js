...
func_name:
    ...
    ret
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="与-c-函数互操作" tabindex="-1"><a class="header-anchor" href="#与-c-函数互操作" aria-hidden="true">#</a> 与 C 函数互操作</h3><p>上面给出的规则描述了 C 函数使用的&quot;调​​用约定&quot;。 （C++ 函数使用相同的调用约定，但 C++ 函数的名称经过修改以包含其参数和返回类型。）</p><p>这意味着通过使用上述规则，我们可以</p><ul><li>调用用 C 编写的函数，包括 C 标准库函数</li><li>从 C/C++ 代码调用汇编函数</li></ul><p>为了调用 C 函数，我们必须做三件事：</p><ul><li>将我们程序的入口写为 main 而不是 _start，声明为全局。在函数入口处正确设置堆栈，在退出时将其拆除，并通过 rax 返回程序的退出代码（即无需使用 SYS_EXIT 系统调用）。</li></ul><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>section .data
...
main:
    ...
    mov rax, 0
    ret
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><table><thead><tr><th>占位符</th><th>描述</th><th>参数类型</th></tr></thead><tbody><tr><td>%c</td><td>单个字符</td><td>int</td></tr><tr><td>%s</td><td>以null结尾的字符串</td><td>char*</td></tr><tr><td>%d</td><td>有符号整型变量</td><td>int</td></tr><tr><td>%ld</td><td>有符号整型变量</td><td>long</td></tr><tr><td>%hd</td><td>有符号整型变量</td><td>short</td></tr><tr><td>%hhd</td><td>有符号整型变量</td><td>char</td></tr><tr><td>%u</td><td>无符号整型变量</td><td>unsigned int</td></tr><tr><td>%lu</td><td></td><td></td></tr><tr><td>%f</td><td>浮点数</td><td>double</td></tr></tbody></table><p>由于 <code>printf</code> 接受任意数量的参数，因此它是一个<strong>可变参数函数</strong>，它为其参数的传递方式添加了一条额外的规则：</p><ul><li>如果 <code>xmm</code> 寄存器中传递了任何浮点参数，则将 <code>al</code> 设置为这些参数的数量。</li></ul><p>printf 的对应项是 scanf，它采用类似的格式化字符串，只不过它根据给定的格式从 stdin 读取输入。其余参数必须是指向将写入输入的变量的指针。例如，如果我们这样做:</p><div class="language-C line-numbers-mode" data-ext="C"><pre class="language-C"><code>int x, y, z;
scanf(&quot;%d %d %d&quot;, &amp;x, &amp;y, &amp;z);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>输入 1 2 3，则变量 x 将包含 1，y 将包含 2，z 将包含 3。</p><p>对于 scanf，使用正确的格式说明符至关重要！例如，当您打算读入 qword 时使用 %d (dword) 会导致问题，通常是因为 scanf 只会写入低位 dword，而高 4 个字节保持不变。</p><h2 id="附录" tabindex="-1"><a class="header-anchor" href="#附录" aria-hidden="true">#</a> 附录</h2><h3 id="课程资源" tabindex="-1"><a class="header-anchor" href="#课程资源" aria-hidden="true">#</a> 课程资源</h3>`,50),p={href:"https://staffwww.fullcoll.edu/aclifton/cs241/lecture-stack-c-functions.html",target:"_blank",rel:"noopener noreferrer"};function m(b,h){const i=c("ExternalLinkIcon");return d(),l("div",null,[o,v,u,n("p",null,[e("原文链接："),n("a",p,[e("https://staffwww.fullcoll.edu/aclifton/cs241/lecture-stack-c-functions.html"),r(i)])])])}const k=a(t,[["render",m],["__file","Lecture8-calling-c-functions.html.vue"]]);export{k as default};

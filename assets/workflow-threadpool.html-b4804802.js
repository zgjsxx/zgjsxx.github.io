...
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">endif</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因为其实c语言编写的代码，为了使其可以被c和c++程序都调用，因此在代码中使用了<code>extern &quot;C&quot;</code>。</p><p>msgqueue的头文件中提供了6个方法，其作用总结如下：</p><ul><li>msgqueue_create：创建msgqueue。</li><li>msgqueue_put：放置任务到msgqueue中。</li><li>msgqueue_get：从msgqueue中取出任务。</li><li>msgqueue_set_nonblock：将msgqueue设置为nonblock。</li><li>msgqueue_set_block：将msgqueue设置为block。</li><li>msgqueue_destroy：销毁msgqueu额。</li></ul><p>上述接口做到了见文知意，值得学习。</p><p>下面看看这些接口是如何实现的。</p><h4 id="msgqueue-create" tabindex="-1"><a class="header-anchor" href="#msgqueue-create" aria-hidden="true">#</a> msgqueue_create</h4><h4 id="msgqueue-put" tabindex="-1"><a class="header-anchor" href="#msgqueue-put" aria-hidden="true">#</a> msgqueue_put</h4><h4 id="msgqueue-get" tabindex="-1"><a class="header-anchor" href="#msgqueue-get" aria-hidden="true">#</a> msgqueue_get</h4><h4 id="msgqueue-set-nonblock" tabindex="-1"><a class="header-anchor" href="#msgqueue-set-nonblock" aria-hidden="true">#</a> msgqueue_set_nonblock</h4><h4 id="msgqueue-set-block" tabindex="-1"><a class="header-anchor" href="#msgqueue-set-block" aria-hidden="true">#</a> msgqueue_set_block</h4><h4 id="msgqueue-destroy" tabindex="-1"><a class="header-anchor" href="#msgqueue-destroy" aria-hidden="true">#</a> msgqueue_destroy</h4><h3 id="thrdpool" tabindex="-1"><a class="header-anchor" href="#thrdpool" aria-hidden="true">#</a> thrdpool</h3><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token keyword">typedef</span> <span class="token keyword">struct</span> <span class="token class-name">msg_t</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,47),o=[e];function c(l,i){return s(),a("div",null,o)}const r=n(p,[["render",c],["__file","workflow-threadpool.html.vue"]]);export{r as default};

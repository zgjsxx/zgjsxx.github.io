import{_ as s,V as n,W as e,a0 as a}from"./framework-9a29aaa0.js";const i={},t=a(`<p>设置https 代理</p><p>Git代理有两种设置方式，分别是全局代理和只对Github代理，建议只对github 代理。 代理协议也有两种，分别是使用http代理和使用socks5代理，建议使用socks5代理。 注意下面代码的端口号需要根据你自己的代理端口设定，比如我的代理socks端口是51837。</p><p>全局设置（不推荐）</p><p>使用http代理</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> config <span class="token parameter variable">--global</span> http.proxy http://127.0.0.1:58591
...
Host github.com
  ...
  ProxyCommand <span class="token string">&quot;C:\\Users\\xxx<span class="token entity" title="\\E">\\E</span>\\Git\\mingw64<span class="token entity" title="\\b">\\b</span>in<span class="token entity" title="\\c">\\c</span>onnect&quot;</span> <span class="token parameter variable">-S</span> <span class="token number">127.0</span>.0.1:1080 <span class="token parameter variable">-a</span> none %h %p
...
Host ssh.github.com
  ...
  TCPKeepAlive <span class="token function">yes</span>
  ProxyCommand <span class="token string">&quot;C:\\Users\\xxx<span class="token entity" title="\\E">\\E</span>\\Git\\mingw64<span class="token entity" title="\\b">\\b</span>in<span class="token entity" title="\\c">\\c</span>onnect&quot;</span> <span class="token parameter variable">-S</span> <span class="token number">127.0</span>.0.1:1080 <span class="token parameter variable">-a</span> none %h %p
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="测试是否设置成功" tabindex="-1"><a class="header-anchor" href="#测试是否设置成功" aria-hidden="true">#</a> 测试是否设置成功</h1><p>ssh -T <a href="mailto:git@github.com">git@github.com</a></p>`,30),l=[t];function c(o,r){return n(),e("div",null,l)}const p=s(i,[["render",c],["__file","git-proxy.html.vue"]]);export{p as default};

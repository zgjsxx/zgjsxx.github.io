...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>讽刺的是，没有无条件 FP 移动指令可以执行相同的操作（将 st0 设置为另一个 st 寄存器的值）！我们能做的就是push.（XMM 浮点系统有一条指令可以查找两个值中的最大值。）</p><p>fcomip 进行比较然后弹出。 fucomi 进行“无序”比较；当操作数之一为非数字时，无序比较的结果会有所不同：</p><p>操作数不是数字:</p><ul><li><p>在有序比较中，NaN 与其他数字之间的比较会导致浮点异常。</p></li><li><p>在无序比较中，NaN 与其他数字之间的比较始终给出真实结果。即，NaN 算作小于、大于、等于和不等于所有其他数字！</p></li></ul><p>通常我们更喜欢无序比较，因为它稍微快一些，并且意味着我们不必处理浮点异常。</p><p>要与常量 0.0 进行比较，请使用 <code>ftst</code>，它将 st0 与 0 进行比较。这样您就不必将常量 0 加载到其他寄存器之一进行比较。</p><h3 id="数学运算" tabindex="-1"><a class="header-anchor" href="#数学运算" aria-hidden="true">#</a> 数学运算</h3><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>; Trig functions
fsin         ; st0 = sin(st0)
fcos         ; st0 = cos(st0)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>dest</code>和<code>src</code>操作数必须是xmm寄存器； <code>src2</code> 可以是寄存器或内存。所有操作数的大小必须相同。</p><p>提供了许多更高级的数学运算作为说明：</p><table><thead><tr><th>指令</th><th>描述</th></tr></thead><tbody><tr><td><code>sqrtss dest, src</code><br> <code>sqrtsd dest, src</code></td><td><code>dest = sqrt(src)</code> 开根号</td></tr><tr><td><code>rcpss dest, src</code></td><td><code>dest = 1/src</code></td></tr><tr><td><code>rsqrtss dest, src</code></td><td><code>dest = 1/sqrt(src)</code></td></tr><tr><td><code>maxss dest, src</code><br> <code>maxsd dest, src</code></td><td>dest =maximum of dest, src</td></tr><tr><td><code>minss dest, src</code><br> <code>minsd dest, src</code></td><td>dest =minimum of dest, src</td></tr><tr><td><code>roundss dest, src, mode</code></td><td>Round src into dest using mode <br>mode = 0 ties go to even<br>mode = 1 round down<br>mode = 2 round up<br>mode = 3 round toward 0</td></tr></tbody></table><h2 id="附录" tabindex="-1"><a class="header-anchor" href="#附录" aria-hidden="true">#</a> 附录</h2>`,73),f={href:"https://staffwww.fullcoll.edu/aclifton/cs241/lecture-floating-point-simd.html",target:"_blank",rel:"noopener noreferrer"},k={href:"https://baseconvert.com/ieee-754-floating-point",target:"_blank",rel:"noopener noreferrer"},y={href:"https://polarisxu.studygolang.com/posts/basic/diagram-float-point/",target:"_blank",rel:"noopener noreferrer"},w={href:"http://www.infophysics.net/x87.pdf",target:"_blank",rel:"noopener noreferrer"};function _(E,P){const e=c("ExternalLinkIcon");return d(),t("div",null,[o,p,m,u,v,b,h,s("p",null,[n("还有一些其他可以推送的常量；请参阅了解"),s("a",x,[n("完整列表"),a(e)]),n("。")]),g,s("p",null,[n("课程原文："),s("a",f,[n("https://staffwww.fullcoll.edu/aclifton/cs241/lecture-floating-point-simd.html"),a(e)])]),s("p",null,[n("浮点数工具： "),s("a",k,[n("https://baseconvert.com/ieee-754-floating-point"),a(e)])]),s("p",null,[n("浮点数： "),s("a",y,[n("https://polarisxu.studygolang.com/posts/basic/diagram-float-point/"),a(e)])]),s("p",null,[n("x87编程： "),s("a",w,[n("http://www.infophysics.net/x87.pdf"),a(e)])])])}const M=l(r,[["render",_],["__file","Lecture10-float-point.html.vue"]]);export{M as default};

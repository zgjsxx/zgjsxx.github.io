...
+                 EAX                  +
+--------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接下来构建<code>edx</code>的低16位，低16位是中断描述符的属性，设置存在位P为1， DPL=0。</p><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>movw $0x8E00,%dx	 // 0x8E00 = 1_00_0111000000000
...
+                 EDX                   +
+---------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接下来的事情就比较简单了，循环的给中断表中的256项内容都设置成哑中断(ignore_int)。最后使用<code>lidt idt_descr</code>加载中断描述符表<code>ldit</code>要求6字节操作数，前2字节是idt表的限长，后4字节是idt表在线性空间的32位基地址。</p><div class="language-x86asm line-numbers-mode" data-ext="x86asm"><pre class="language-x86asm"><code>	lea idt,%edi
	mov $256,%ecx
rp_sidt:
	movl %eax,(%edi)
	movl %edx,4(%edi)

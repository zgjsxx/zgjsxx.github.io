...
怎么少搬数据？
怎么把 GPU 喂饱？
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>大模型看起来像是在“理解语言”。</p><p>但从硬件视角看，它其实是在一层又一层地做矩阵乘法。</p><p>智能的表象背后，是海量矩阵、海量数据搬运，以及 GPU 上成千上万个线程的并行计算。</p><p><strong>当你真正理解了矩阵乘法，你就已经摸到了现代 AI 计算的地基。</strong></p><p><strong>当你真正理解了 Tile 分块，你就已经拿到了理解 GPU 加速的第一把钥匙。</strong></p>`,21);function P(X,G){return i(),l("div",null,[t,c,p,r,u,o,v,e(" 这是一张图片，ocr 内容为： "),m,e(" 这是一张图片，ocr 内容为： "),g,e(" 这是一张图片，ocr 内容为： "),b,e(" 这是一张图片，ocr 内容为： "),x,e(" 这是一张图片，ocr 内容为： "),h,e(" 这是一张图片，ocr 内容为： "),k,e(" 这是一张图片，ocr 内容为： "),f,e(" 这是一张图片，ocr 内容为： "),_,e(" 这是一张图片，ocr 内容为： "),A,e(" 这是一张图片，ocr 内容为： "),y,e(" 这是一张图片，ocr 内容为： "),C,e(" 这是一张图片，ocr 内容为： "),B,e(" 这是一张图片，ocr 内容为： "),U])}const M=s(d,[["render",P],["__file","大模型的核心，竟然只是矩阵乘法？.html.vue"]]);export{M as default};

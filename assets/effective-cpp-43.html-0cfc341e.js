import{_ as t,V as o,W as c,X as n,Y as s,$ as e,a0 as p,F as l}from"./framework-c954d91f.js";const i={},r=p(`<h1 id="effective-c-43-处理模板化基类的名称" tabindex="-1"><a class="header-anchor" href="#effective-c-43-处理模板化基类的名称" aria-hidden="true">#</a> effective c++ 43-处理模板化基类的名称</h1><p>该节主要分析了一个写模板时常常会遇到的一个编译错误。</p><h2 id="分析" tabindex="-1"><a class="header-anchor" href="#分析" aria-hidden="true">#</a> 分析</h2><p>这里有一个模板基类，有派生类继承了模板基类，并调用了基类中的方法，但是编译器却会报找不该方法，这是怎么回事？</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;string&gt;</span></span>
...
<span class="token keyword">public</span><span class="token operator">:</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13),u={href:"https://godbolt.org/z/hMEcPoEPf",target:"_blank",rel:"noopener noreferrer"},d=p(`<p><strong>第二种</strong>就是在派生类中调用模板基类中的方法时加上使用<code>using</code></p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token keyword">template</span><span class="token operator">&lt;</span><span class="token keyword">typename</span> <span class="token class-name">Company</span><span class="token operator">&gt;</span>
<span class="token keyword">class</span> <span class="token class-name">LoggingMsgSender</span> <span class="token operator">:</span> <span class="token base-clause"><span class="token keyword">public</span> <span class="token class-name">MsgSender</span><span class="token operator">&lt;</span><span class="token class-name">Company</span><span class="token operator">&gt;</span></span>
<span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),m={href:"https://godbolt.org/z/e43z7T7rc",target:"_blank",rel:"noopener noreferrer"},b=n("h2",{id:"总结",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#总结","aria-hidden":"true"},"#"),s(" 总结")],-1),g=n("ul",null,[n("li",null,"在派生类模板中如果需要调用模板基类的方法，需要使用this->，或者明确指出名称。")],-1);function y(f,w){const a=l("ExternalLinkIcon");return o(),c("div",null,[r,n("p",null,[n("a",u,[s("have a try"),e(a)])]),d,n("p",null,[n("a",k,[s("have a try"),e(a)])]),v,n("p",null,[n("a",m,[s("have a try"),e(a)])]),b,g])}const C=t(i,[["render",y],["__file","effective-cpp-43.html.vue"]]);export{C as default};

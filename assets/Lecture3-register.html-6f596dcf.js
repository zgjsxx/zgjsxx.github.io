...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="操作数" tabindex="-1"><a class="header-anchor" href="#操作数" aria-hidden="true">#</a> 操作数</h2><p>每条汇编指令都有许多&quot;操作数&quot;。最大的指令有三个操作数，大多数有两个或一个，有些（如系统调用）没有。每个操作数可以是以下内容之一（有一些限制，具体取决于具体指令）。</p><ul><li>register的名字，例如<code>rax</code>。</li><li>一个常量，例如 60 或 msg。</li><li>内存直接查找。</li><li>内存间接查找。<code>[rax]</code>给出了内存中存储在rax寄存器中的存储的地址处的值。</li></ul>`,9),d=[l];function r(c,v){return s(),a("div",null,d)}const t=e(n,[["render",r],["__file","Lecture3-register.html.vue"]]);export{t as default};

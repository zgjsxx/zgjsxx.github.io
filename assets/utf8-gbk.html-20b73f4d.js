import{_ as a,V as t,W as p,X as n,Y as e,$ as o,a1 as c,F as i}from"./framework-8842c3e4.js";const l={},u=c(`<h1 id="utf8转gbk代码" tabindex="-1"><a class="header-anchor" href="#utf8转gbk代码" aria-hidden="true">#</a> UTF8转GBK代码</h1><p>目录结构如下：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost gbk-utf8<span class="token punctuation">]</span><span class="token comment"># tree</span>
